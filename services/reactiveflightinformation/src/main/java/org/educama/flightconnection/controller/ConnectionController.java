...
public class ConnectionController {
     ...
     */
    @RequestMapping(path = "/connections", produces = TEXT_EVENT_STREAM_VALUE)
    public Flux<Connection> getAllConnectionFromSourceToDestination(@RequestParam(value = "from") String sourceAirportIata, @RequestParam(value = "to") String destinationAirportIata) {
